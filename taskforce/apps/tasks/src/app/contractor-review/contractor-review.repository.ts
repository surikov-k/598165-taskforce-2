...
@Injectable()
export class ContractorReviewRepository implements CRUDRepository<ContractorReviewEntity, number, Review> {
  ...
  public async update(id: number, item: ContractorReviewEntity): Promise<Review> {
